...
@Entity
public class YearFourStudentRecords{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int YearFourStuRec_Id;
    @ManyToOne
    ...
    // Getter and Setter
    public int getYearFourStuRec_Id() {
        return YearFourStuRec_Id;
    }

    public void setYearFourStuRec_Id(int YearFourStuRec_Id) {
        YearFourStuRec_Id = YearFourStuRec_Id;
    }
    ...
    public String getStudent4thSemResult() {
        return student4thSemResult;
    }

    public void setStudent4thSemResult(String student4thSemResult) {
        this.student4thSemResult = student4thSemResult;
    }
    ...
    public String toString() {
        return " YearFourStudentRecords { YearFourStuRec_Id =" + YearFourStuRec_Id +
                ", firstName =" + firstName +
                ",  lastName =" + lastName +
