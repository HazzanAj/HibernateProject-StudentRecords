...
@Entity
public class YearThreeStudentRecords{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int YearThreeStuRec_Id;
    @ManyToOne
    ...
    //Getter and Setter
    public int getYearThreeStuRec_Id() {
        return YearThreeStuRec_Id;
    }

    public void setYearThreeStuRec_Id(int YearThreeStuRec_Id) {
        YearThreeStuRec_Id = YearThreeStuRec_Id;
    }
    ...
    public String toString() {
        return " YearThreeStudentRecords { YearThreeStuRec_Id =" + YearThreeStuRec_Id +
                ", firstName =" + firstName +
                ",  lastName =" + lastName +
