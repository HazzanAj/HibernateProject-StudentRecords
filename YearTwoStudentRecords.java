...
@Entity
public class YearTwoStudentRecords {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int YearTwoStuRec_Id;
    @ManyToOne
    ...
    public int getYearTwoStuRec_Id() {

        return YearTwoStuRec_Id;
    }

    public void setYearTwoStuRec_Id(int yearTwoStuRec_Id) {

        yearTwoStuRec_Id = yearTwoStuRec_Id;
    }
    ...
    public String toString() {
        return " YearTwoStudentRecords { YearTwoStuRec_Id =" + YearTwoStuRec_Id +
                ", firstName =" + firstName +
                ",  lastName =" + lastName +
